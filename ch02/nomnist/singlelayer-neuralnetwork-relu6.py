...
def main():
    ...
    with graph.as_default():
        ...
        hidden1 = tf.nn.relu6(tf.matmul(tf_train_dataset, w1) + b1)
        ...
        valid_prediction = tf.nn.softmax(
            tf.matmul(tf.nn.relu6(tf.matmul(tf_valid_dataset, w1) + b1), w2) + b2)
        test_prediction = tf.nn.softmax(
            tf.matmul(tf.nn.relu6(tf.matmul(tf_test_dataset, w1) + b1), w2) + b2)
