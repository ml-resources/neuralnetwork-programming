...
# We use term frequency-inverse document frequency (TF-IDF) to weigh words
# and build a vocabulary for use as a vector. TensorFlow is used to develop a one-layer NN for quick training.
...
file = open('/Users/manpreet.singh/Sandbox/codehub/github/neuralnetwork-programming/ch05/sentiment-analysis/smsspamcollection/SMSSpamCollection',
            encoding="utf-8")
# Format Data
